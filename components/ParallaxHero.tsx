        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div>
            <motion.span
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur-sm text-forest text-sm font-medium rounded-full mb-14 border border-forest/20"
            >
            ...
            {/* CTA Button - Inside parallax container but without movement */}
            <motion.div
              initial={{ opacity: 0, x: -30 }}
              animate={{ opacity: 1, x: 0 }}
